...
def _header_footer(canvas, doc) -> None:
    ...
    canvas.drawCentredString(
        ...
        f"Nishchal Baniya, Himalayan Carbon Nepal | nishchal.baniya@himalayancarbonnepal.com | Page {doc.page}"
    )
    canvas.restoreState()
...
def generate_iso_14064_report(
    ...
    r.small(
        ...
        f"Author: Nishchal Baniya, Himalayan Carbon Nepal. License: MIT."
    )
...
def generate_tcfd_pdf_report(
    ...
    r.small(
        ...
        f"Author: Nishchal Baniya, Himalayan Carbon Nepal."
    )
    r.save()
    return out_path
