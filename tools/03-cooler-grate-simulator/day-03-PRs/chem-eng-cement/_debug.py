"""Helper: inspect per-compartment results in detail. Used during
debugging the v0.3.0 -> v0.3.1 migration. Not part of the PR.
"""
import sys, os
...
print(f"max T_a - T_c: {diff.max():.1f}, min: {diff.min():.1f}")
